...
import cn.ucai.foraging.task.DownloadImageTask;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.foraging.R.layout.alert_dialog);
		mTextView = (TextView) findViewById(cn.ucai.foraging.R.id.title);
		mButton = (Button) findViewById(cn.ucai.foraging.R.id.btn_cancel);
		imageView = (ImageView) findViewById(cn.ucai.foraging.R.id.image);
		editText = (EditText) findViewById(cn.ucai.foraging.R.id.edit);
		//提示内容
		...
		if(msg != null)
		    ((TextView)findViewById(cn.ucai.foraging.R.id.alert_message)).setText(msg);
		if(title != null)
		...
		if(path != null){
		    ...
		    ((TextView)findViewById(cn.ucai.foraging.R.id.alert_message)).setVisibility(View.GONE);
