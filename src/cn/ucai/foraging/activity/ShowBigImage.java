...
import cn.ucai.foraging.task.LoadLocalBigImgTask;
import cn.ucai.foraging.utils.ImageCache;
import cn.ucai.foraging.widget.photoview.PhotoView;
import cn.ucai.foraging.widget.photoview.PhotoViewAttacher;
...
public class ShowBigImage extends BaseActivity {
	...
	private int default_res = cn.ucai.foraging.R.drawable.default_image;
	...
	protected void onCreate(Bundle savedInstanceState) {
		setContentView(cn.ucai.foraging.R.layout.activity_show_big_image);
		super.onCreate(savedInstanceState);

		image = (PhotoView) findViewById(cn.ucai.foraging.R.id.image);
		loadLocalPb = (ProgressBar) findViewById(cn.ucai.foraging.R.id.pb_load_local);
		default_res = getIntent().getIntExtra("default_image", cn.ucai.foraging.R.drawable.default_avatar);
	...
	private void downloadImage(final String remoteFilePath, final Map<String, String> headers) {
		String str1 = getResources().getString(cn.ucai.foraging.R.string.Download_the_pictures);
		...
		final EMCallBack callback = new EMCallBack() {
			...
			public void onProgress(final int progress, String status) {
				...
				final String str2 = getResources().getString(cn.ucai.foraging.R.string.Download_the_pictures_new);
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
