...
public class MainActivity extends BaseActivity implements EMEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.foraging.R.layout.activity_main);
		initView();
	...
	static void asyncFetchContactsFromServer(){
	    HXSDKHelper.getInstance().asyncFetchContactsFromServer(new EMValueCallBack<List<String>>(){
            ...
            public void onSuccess(List<String> usernames) {
                ...
                String strChat = context.getString(cn.ucai.foraging.R.string.Application_and_notify);
                newFriends.setNick(strChat);
        
                userlist.put(Constant.NEW_FRIENDS_USERNAME, newFriends);
                // 添加"群聊"
                User groupUser = new User();
                String strGroup = context.getString(cn.ucai.foraging.R.string.group_chat);
                ...
                String strChatRoom = context.getString(cn.ucai.foraging.R.string.chat_room);
        		...
        		String strRobot = context.getString(cn.ucai.foraging.R.string.robot_chat);
...
//					unreadAddressLable.setText(String.valueOf(count));
	...
	public class MyConnectionListener implements EMConnectionListener {
		...
		public void onDisconnected(final int error) {
			final String st1 = getResources().getString(cn.ucai.foraging.R.string.can_not_connect_chat_server_connection);
			final String st2 = getResources().getString(cn.ucai.foraging.R.string.the_current_network);
			runOnUiThread(new Runnable() {
	...
	public class MyGroupChangeListener implements EMGroupChangeListener {
		...
		public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
			...
			// 被邀请
			String st3 = getResources().getString(cn.ucai.foraging.R.string.Invite_you_to_join_a_group_chat);
		...
		public void onApplicationAccept(String groupId, String groupName, String accepter) {
			...
			String st4 = getResources().getString(cn.ucai.foraging.R.string.Agreed_to_your_group_chat_application);
			// 加群申请被同意
			EMMessage msg = EMMessage.createReceiveMessage(Type.TXT);
			msg.setChatType(ChatType.GroupChat);
	...
	private void showConflictDialog() {
		...
		String st = getResources().getString(cn.ucai.foraging.R.string.Logoff_notification);
		if (!MainActivity.this.isFinishing()) {
			...
			try {
				...
				conflictBuilder.setMessage(cn.ucai.foraging.R.string.connect_conflict);
				conflictBuilder.setPositiveButton(cn.ucai.foraging.R.string.ok, new DialogInterface.OnClickListener() {
	...
	private void showAccountRemovedDialog() {
		...
		DemoHXSDKHelper.getInstance().logout(true,null);
		String st5 = getResources().getString(cn.ucai.foraging.R.string.Remove_the_notification);
		if (!MainActivity.this.isFinishing()) {
			// clear up global variables
			try {
				...
				accountRemovedBuilder.setMessage(cn.ucai.foraging.R.string.em_user_remove);
				accountRemovedBuilder.setPositiveButton(cn.ucai.foraging.R.string.ok, new DialogInterface.OnClickListener() {
