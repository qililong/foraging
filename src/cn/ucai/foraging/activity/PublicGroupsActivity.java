...
public class PublicGroupsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.foraging.R.layout.activity_public_groups);

		pb = (ProgressBar) findViewById(cn.ucai.foraging.R.id.progressBar);
		listView = (ListView) findViewById(cn.ucai.foraging.R.id.list);
		groupsList = new ArrayList<EMGroupInfo>();
		searchBtn = (Button) findViewById(cn.ucai.foraging.R.id.btn_search);
		
		View footView = getLayoutInflater().inflate(cn.ucai.foraging.R.layout.listview_footer_view, null);
        footLoadingLayout = (LinearLayout) footView.findViewById(cn.ucai.foraging.R.id.loading_layout);
        footLoadingPB = (ProgressBar)footView.findViewById(cn.ucai.foraging.R.id.loading_bar);
        footLoadingText = (TextView) footView.findViewById(cn.ucai.foraging.R.id.loading_text);
	...
	private class GroupsAdapter extends ArrayAdapter<EMGroupInfo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			((TextView) convertView.findViewById(cn.ucai.foraging.R.id.name)).setText(getItem(position).getGroupName());
