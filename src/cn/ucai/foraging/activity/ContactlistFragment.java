...
public class ContactlistFragment extends Fragment {
				    ...
				    getActivity().runOnUiThread(new Runnable(){
		                ...
		                public void run() {
		                    if(success){
		                        ...
		                        String s1 = getResources().getString(cn.ucai.foraging.R.string.get_failed_please_check);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(cn.ucai.foraging.R.layout.fragment_contact_list, container, false);
	}
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		if (((AdapterContextMenuInfo) menuInfo).position > 3) {
			...
			getActivity().getMenuInflater().inflate(cn.ucai.foraging.R.menu.context_contact_list, menu);
		}
	}

	@Override
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == cn.ucai.foraging.R.id.delete_contact) {
			try {
                // 删除此联系人
			...
			return true;
		}else if(item.getItemId() == cn.ucai.foraging.R.id.add_to_blacklist){
