...
import cn.ucai.foraging.video.util.Utils;
...
public class RecorderVideoActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.foraging.R.layout.recorder_activity);
	...
	private void initViews() {
		btn_switch = (Button) findViewById(cn.ucai.foraging.R.id.switch_btn);
		btn_switch.setOnClickListener(this);
		btn_switch.setVisibility(View.VISIBLE);
		mVideoView = (VideoView) findViewById(cn.ucai.foraging.R.id.mVideoView);
		btnStart = (ImageView) findViewById(cn.ucai.foraging.R.id.recorder_start);
		btnStop = (ImageView) findViewById(cn.ucai.foraging.R.id.recorder_stop);
...
//		}
	...
	public void onClick(View view) {
		switch (view.getId()) {
		case cn.ucai.foraging.R.id.switch_btn:
			switchCamera();
			break;
		case cn.ucai.foraging.R.id.recorder_start:
			// start recording
		    if(!startRecording())
		        return;
			Toast.makeText(this, cn.ucai.foraging.R.string.The_video_to_start, Toast.LENGTH_SHORT).show();
			...
			chronometer.start();
			break;
		case cn.ucai.foraging.R.id.recorder_stop:
			...
			new AlertDialog.Builder(this)
					.setMessage(cn.ucai.foraging.R.string.Whether_to_send)
					.setPositiveButton(cn.ucai.foraging.R.string.ok,
					...
					.setNegativeButton(cn.ucai.foraging.R.string.cancel,
							new DialogInterface.OnClickListener() {
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			String st3 = getResources().getString(cn.ucai.foraging.R.string.Whether_to_send);
			new AlertDialog.Builder(this)
					.setMessage(st3)
					.setPositiveButton(cn.ucai.foraging.R.string.ok,
							new DialogInterface.OnClickListener() {
							...
							}).setNegativeButton(cn.ucai.foraging.R.string.cancel, null)
					.setCancelable(false).show();
		}
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this)
				.setTitle(cn.ucai.foraging.R.string.prompt)
				.setMessage(cn.ucai.foraging.R.string.Open_the_equipment_failure)
				.setPositiveButton(cn.ucai.foraging.R.string.ok,
						new DialogInterface.OnClickListener() {
