	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ViewHolder holder;
 		if(convertView == null){
			...
			holder.unreadMsgView = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.unread_msg_number);
			holder.nameTextview = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.name);
			holder.tvHeader = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.header);
		...
		if(username.equals(Constant.NEW_FRIENDS_USERNAME)){
		    ...
		    holder.avatar.setImageResource(cn.ucai.foraging.R.drawable.new_friends_icon);
...
//			    holder.unreadMsgView.setText(user.getUnreadMsgCount()+"");
	...
	public Object[] getSections() {
		...
		list.add(getContext().getString(cn.ucai.foraging.R.string.search_header));
