 ...
 */
package cn.ucai.foraging.adapter;
...
import cn.ucai.foraging.activity.AlertDialog;
import cn.ucai.foraging.activity.BaiduMapActivity;
import cn.ucai.foraging.activity.ChatActivity;
import cn.ucai.foraging.activity.ContextMenu;
import cn.ucai.foraging.activity.ShowBigImage;
import cn.ucai.foraging.activity.ShowNormalFileActivity;
import cn.ucai.foraging.activity.ShowVideoActivity;
import cn.ucai.foraging.activity.UserProfileActivity;
import cn.ucai.foraging.task.LoadImageTask;
import cn.ucai.foraging.task.LoadVideoImageTask;
import cn.ucai.foraging.utils.DateUtils;
import cn.ucai.foraging.utils.ImageCache;
import cn.ucai.foraging.utils.ImageUtils;
import cn.ucai.foraging.utils.SmileUtils;
import cn.ucai.foraging.utils.UserUtils;
...
public class MessageAdapter extends BaseAdapter{
	...
	private View createViewByMessage(EMMessage message, int position) {
		...
		case LOCATION:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_location, null) : inflater.inflate(
					cn.ucai.foraging.R.layout.row_sent_location, null);
		case IMAGE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_picture, null) : inflater.inflate(
					cn.ucai.foraging.R.layout.row_sent_picture, null);

		case VOICE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_voice, null) : inflater.inflate(
					cn.ucai.foraging.R.layout.row_sent_voice, null);
		case VIDEO:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_video, null) : inflater.inflate(
					cn.ucai.foraging.R.layout.row_sent_video, null);
		case FILE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_file, null) : inflater.inflate(
					cn.ucai.foraging.R.layout.row_sent_file, null);
		default:
			// 语音通话
			if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VOICE_CALL, false))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_voice_call, null) : inflater
						.inflate(cn.ucai.foraging.R.layout.row_sent_voice_call, null);
			// 视频通话
			else if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VIDEO_CALL, false))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_video_call,
						null) : inflater.inflate(cn.ucai.foraging.R.layout.row_sent_video_call, null);
			// 含有菜单的消息	
			else if (((DemoHXSDKHelper)HXSDKHelper.getInstance()).isRobotMenuMessage(message))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_menu, null)
						: inflater.inflate(cn.ucai.foraging.R.layout.row_sent_message, null);
			else
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.foraging.R.layout.row_received_message,
						null) : inflater.inflate(cn.ucai.foraging.R.layout.row_sent_message, null);
		}
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			if (message.getType() == EMMessage.Type.IMAGE) {
				try {
					holder.iv = ((ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_sendPicture));
					holder.iv_avatar = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_userhead);
					holder.tv = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.percentage);
					holder.pb = (ProgressBar) convertView.findViewById(cn.ucai.foraging.R.id.progressBar);
					holder.staus_iv = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.msg_status);
					holder.tv_usernick = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_userid);
				} catch (Exception e) {
				}
				...
				try {
					holder.pb = (ProgressBar) convertView.findViewById(cn.ucai.foraging.R.id.pb_sending);
					holder.staus_iv = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.msg_status);
					holder.iv_avatar = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_userhead);
					// 这里是文字内容
					holder.tv = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_chatcontent);
					holder.tv_usernick = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_userid);
					
					holder.tvTitle = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tvTitle);
					holder.tvList = (LinearLayout) convertView.findViewById(cn.ucai.foraging.R.id.ll_layout);
				} catch (Exception e) {
				}
				...
				if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VOICE_CALL, false)
					...
					holder.iv = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_call_icon);
					holder.tv = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_chatcontent);
				}

			} else if (message.getType() == EMMessage.Type.VOICE) {
				try {
					holder.iv = ((ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_voice));
					holder.iv_avatar = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_userhead);
					holder.tv = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_length);
					holder.pb = (ProgressBar) convertView.findViewById(cn.ucai.foraging.R.id.pb_sending);
					holder.staus_iv = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.msg_status);
					holder.tv_usernick = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_userid);
					holder.iv_read_status = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_unread_voice);
				} catch (Exception e) {
				}
			} else if (message.getType() == EMMessage.Type.LOCATION) {
				try {
					holder.iv_avatar = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_userhead);
					holder.tv = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_location);
					holder.pb = (ProgressBar) convertView.findViewById(cn.ucai.foraging.R.id.pb_sending);
					holder.staus_iv = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.msg_status);
					holder.tv_usernick = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_userid);
				} catch (Exception e) {
				...
				try {
					holder.iv = ((ImageView) convertView.findViewById(cn.ucai.foraging.R.id.chatting_content_iv));
					holder.iv_avatar = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_userhead);
					holder.tv = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.percentage);
					holder.pb = (ProgressBar) convertView.findViewById(cn.ucai.foraging.R.id.progressBar);
					holder.staus_iv = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.msg_status);
					holder.size = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.chatting_size_iv);
					holder.timeLength = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.chatting_length_iv);
					holder.playBtn = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.chatting_status_btn);
					holder.container_status_btn = (LinearLayout) convertView.findViewById(cn.ucai.foraging.R.id.container_status_btn);
					holder.tv_usernick = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_userid);
				...
				try {
					holder.iv_avatar = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.iv_userhead);
					holder.tv_file_name = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_file_name);
					holder.tv_file_size = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_file_size);
					holder.pb = (ProgressBar) convertView.findViewById(cn.ucai.foraging.R.id.pb_sending);
					holder.staus_iv = (ImageView) convertView.findViewById(cn.ucai.foraging.R.id.msg_status);
					holder.tv_file_download_state = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_file_state);
					holder.ll_container = (LinearLayout) convertView.findViewById(cn.ucai.foraging.R.id.ll_file_container);
					// 这里是进度值
					holder.tv = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.percentage);
				} catch (Exception e) {
				}
		...
		if (!(chatType == ChatType.GroupChat || chatType == ChatType.ChatRoom) && message.direct == EMMessage.Direct.SEND) {
			holder.tv_ack = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_ack);
			holder.tv_delivered = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_delivered);
		...
		if (message.direct == EMMessage.Direct.SEND) {
			View statusView = convertView.findViewById(cn.ucai.foraging.R.id.msg_status);
			// 重发按钮点击事件
			statusView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					intent.putExtra("msg", activity.getString(cn.ucai.foraging.R.string.confirm_resend));
					intent.putExtra("title", activity.getString(cn.ucai.foraging.R.string.resend));
			...
			final String st = context.getResources().getString(cn.ucai.foraging.R.string.Into_the_blacklist);
		...
		TextView timestamp = (TextView) convertView.findViewById(cn.ucai.foraging.R.id.timestamp);
	...
	private void setRobotMenuMessageLayout(LinearLayout parentView,JSONArray jsonArr){
		try {
			...
			for (int i = 0; i < jsonArr.length(); i++) {
				...
				try {
					XmlPullParser xrp = context.getResources().getXml(cn.ucai.foraging.R.drawable.menu_msg_text_color);
	...
	private void handleImageMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			...
			if (message.status == EMMessage.Status.INPROGRESS) {
				// "!!!! back receive";
				holder.iv.setImageResource(cn.ucai.foraging.R.drawable.default_image);
						...
						public void run() {
							...
							if (message.status == EMMessage.Status.SUCCESS) {
								...
								Toast.makeText(activity,
										activity.getString(cn.ucai.foraging.R.string.send_fail) + activity.getString(cn.ucai.foraging.R.string.connect_failuer_toast), 0)
										.show();
								timer.cancel();
							}
	...
	private void handleVideoMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		holder.playBtn.setImageResource(cn.ucai.foraging.R.drawable.video_download_btn_nor);
	...
	private void handleVoiceMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		if (((ChatActivity)activity).playMsgId != null
			...
			if (message.direct == EMMessage.Direct.RECEIVE) {
				holder.iv.setImageResource(cn.ucai.foraging.R.anim.voice_from_icon);
			} else {
				holder.iv.setImageResource(cn.ucai.foraging.R.anim.voice_to_icon);
			}
			voiceAnimation = (AnimationDrawable) holder.iv.getDrawable();
			voiceAnimation.start();
		} else {
			if (message.direct == EMMessage.Direct.RECEIVE) {
				holder.iv.setImageResource(cn.ucai.foraging.R.drawable.chatfrom_voice_playing);
			} else {
				holder.iv.setImageResource(cn.ucai.foraging.R.drawable.chatto_voice_playing);
			}
		}
	...
	private void handleFileMessage(final EMMessage message, final ViewHolder holder, int position, View convertView) {
		...
		String st1 = context.getResources().getString(cn.ucai.foraging.R.string.Have_downloaded);
		String st2 = context.getResources().getString(cn.ucai.foraging.R.string.Did_not_download);
	...
	private void handleLocationMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		TextView locationView = ((TextView) convertView.findViewById(cn.ucai.foraging.R.id.tv_location));
				...
				public void onError(int code, String error) {
					...
					activity.runOnUiThread(new Runnable() {
						public void run() {
							...
							holder.staus_iv.setVisibility(View.VISIBLE);
							Toast.makeText(activity,
									activity.getString(cn.ucai.foraging.R.string.send_fail) + activity.getString(cn.ucai.foraging.R.string.connect_failuer_toast), 0).show();
						}
					});
				}
			...
			public void run() {
				...
				if (message.status == EMMessage.Status.SUCCESS) {
				    ...
				    if(message.getError() == EMError.MESSAGE_SEND_INVALID_CONTENT){
				        Toast.makeText(activity, activity.getString(cn.ucai.foraging.R.string.send_fail) + activity.getString(cn.ucai.foraging.R.string.error_send_invalid_content), 0)
                        .show();
				    }else if(message.getError() == EMError.MESSAGE_SEND_NOT_IN_THE_GROUP){
				        Toast.makeText(activity, activity.getString(cn.ucai.foraging.R.string.send_fail) + activity.getString(cn.ucai.foraging.R.string.error_send_not_in_the_group), 0)
                        .show();
				    }else{
				        Toast.makeText(activity, activity.getString(cn.ucai.foraging.R.string.send_fail) + activity.getString(cn.ucai.foraging.R.string.connect_failuer_toast), 0)
                        .show();
				    }
				}
