 ...
 */
package cn.ucai.foraging.widget;
...
public class Sidebar extends View{
	...
	private void init(){
	    String st = context.getString(cn.ucai.foraging.R.string.search_new);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				header = (TextView) ((View)getParent()).findViewById(cn.ucai.foraging.R.id.floating_header);
			}
			setHeaderTextAndscroll(event);
			header.setVisibility(View.VISIBLE);
			setBackgroundResource(cn.ucai.foraging.R.drawable.sidebar_background_pressed);
			return true;
		}
